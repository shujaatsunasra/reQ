...
```
"Show me temperature profiles in the Arabian Sea from last month"

"What's happening with salinity in the North Atlantic?"

"Find all floats near the equator with anomalies above 36 PSU"

"Compare temperature gradients between Indian Ocean and Pacific"

"Show me the trajectory of float 1900975 over the last year"
```
